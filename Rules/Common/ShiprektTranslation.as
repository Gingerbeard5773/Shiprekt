...
namespace Trans
{
	...
	Ship          = Translate("Ship\\Корабль\\Navio"),
	Speed         = Translate("Speed\\Скорость\\Velocidade"),
	...
	Relinquish    = Translate("Click to relinquish ownership of a nearby seat\\Нажми чтобы завладеть ближайшим креслом\\Clique para renunciar a liderança de um assento próximo"),
	...
	Reclaiming    = Translate("You are reclaiming someone else's property. Progress will be slower\\##\\Você está reivindicando a propriedade de outra pessoa. O progresso será mais lento"),
	WarmupPlacing = Translate("You can only place Couplings and Repulsors on the Mothership during warm-up\\#\\Você só pode colocar Acoplamntos e Repulsores no Navio-mãe durante o aquecimento"),
	ReleaseCoup1  = Translate("Use left click to release them individually or right click to release all the couplings you've placed\\##\\Use o botão esquerdo para soltá-los individualmente ou botão direito para soltar todos os acoplamentos que você colocou"),
	ReleaseCoup2  = Translate("PRESS AND HOLD SPACEBAR TO RELEASE COUPLINGS\\##\\PRESSIONE E SEGURE A BARRA DE ESPAÇO PARA LIBERAR ACOPLAMENTOS"),
	FlaksLimit    = Translate("Flaks limit reached!\\##\\Limite de antiaéreos alcançado!"),
	BootyTransW   = Translate("Click to transfer Booty (enabled after warm-up)\\##\\Clique para transferir Saque (habilitado após aquecimento)"),
	BootyTransM   = Translate("Click to transfer Booty ({booty} Booty minimum)\\##\\Clique para transferir Saque ({booty} Saque mínimo)"),
	FindNewTip    = Translate("Press Right Click to find another tip\\##\\Pressione Botão Direito para achar outra dica"),
	Respawn       = Translate("Respawning...\\##\\Renascendo..."),
	RespawnSoon   = Translate("Respawning soon...\\##\\Renascendo em breve..."),
	...
	FreebuildMode = Translate("Free-build mode\\##\\Modo de Construção Livre"),
	SpeedThings   = Translate("Speed things up!\\##\\Acelere as coisas!"),
	ActiveDeath   = Translate("Sudden Death is already active!\\##\\Morte Súbita já está ativa!"),
	DeathStarted  = Translate("Sudden Death Started! Focus on destroying your enemies' engines so they can't escape the Whirlpool!\\##\\Morte Súbita Começou! Foque em destruir os motores de seus inimigos para que eles não consigam escapar do Redemoinho!"),
	AttackReward  = Translate("Players get a huge Booty reward bonus from direct attacks.\\##\\Jogadores ganham uma enorme recompensa bonus de Saque com ataques diretos."),
	WeightNote    = Translate("Note: removing heavy blocks from your ship doesn't help! Heavier ships are pulled less by the Whirlpool\\##\\Aviso: remover blocos pesados do seu navio não ajuda! Navios mais pesados são menos puxados pelo Redemoinho"),
	BuildEnabled  = Translate("Free building mode enabled. Blocks are free! Start a new free building mode vote to return to the normal game mode\\##\\Modo de construção livre habilitado. Blocos são grátis! Inicie uma nova votação de modo de construção livre para retornar ao modo de jogo normal"),
	BuildDisabled = Translate("Free building mode disabled. Start a new free building mode vote to return to the free building game mode\\##\\Modo de construção livre desabilitado. Inicie uma nova votação de modo de construção livre para retornar ao modo de jogo de construção"),
	SwitchTime    = Translate("Time left to switch again:\\##\\Tempo restante para mudar novamente:"),
	Minutes       = Translate("minutes\\##\\minutos"),
	TooLong       = Translate("Match taking too long?\\##\\Partida demorando demais?"),
	Enable        = Translate("Enable\\##\\Habilitar"),
	Disable       = Translate("Disable\\##\\Desabilitar"),
	Failed        = Translate("Failed\\##\\Falhou"),
	
	//Help menu
	Welcome       = Translate("Welcome to Shiprekt! Made by Strathos, Chrispin, and various other community members.\nLast changes and fixes by\\##\\Bem-vindo ao Shiprekt! Feito por Strathos, Chrispin e diversos membros da comunidade.\nÚltimas mudanças e correções por"),
	Version       = Translate("Version\\Версия\\Versão"),
	LastChanges   = Translate("Last Changes\\##\\Últimas mudanças"),
	...
	Caption1      = Translate("Use Propellers and Couplings to build Torpedoes\\##\\Use Hélices e Acoplamentos para construir Torpedos"),
	Caption2      = Translate("Couplings let you dock with your Mothership\\##\\Acoplamentos lhe permitem atracar com seu Navio-mãe"),
	Caption3      = Translate("Use Couplings to build new ships\\##\\Use Acoplamentos para construir novos navios"),
	Caption4      = Translate("Navigate to Xs to gather Booty\\##\\Navegue até Xs para coletar Saque"),
	...
	AccessTools   = Translate("access the tools menu.\\открыть меню инструментов.\\acessar o menu de ferramentas."),
	...
	Strafe        = Translate("toggle engines strafe mode\\##\\habilitar o modo strafe dos motores"),
	
	//Build menu
	Components    = Translate("Components\\Компоненты\\Componentes"),
	AmmoCap       = Translate("AmmoCap\\Боеприпасы\\Munição"),
	WarmupWarning = Translate("Weapons are enabled after the warm-up time ends\\##\\Armas são habilitadas depois que o tempo do aquecimendo acabar"),
	BuyAgain      = Translate("Press the inventory key to buy again.\\##\\Pressione a tecla de inventário para comprar novamente."),
	...
	AuxillDesc    = Translate("Similar to the Mothership core. Very powerful - gives greater independence to support ships.\\Подобно Сердцу главного корабля. Очень мощный - дает большую независимость мини-кораблям.\\Semelhante ao núcleo do Navio-mãe. Muito poderoso - fornece maior independência para navios de suporte."),
	...
	//Tools
	ToolsMenu     = Translate("Tools Menu\\##\\Menu de Ferramentas"),
	...
	DeconstDesc   = Translate("A tool that can reclaim ship parts for booty.\\Инструмент для разборки частей корабля на Добычу.\\Uma ferramenta que consegue recuperar partes do navio para saque."),
	...
	//Events
	SettingFree   = Translate("{playercount} player(s) in map. Setting freebuild mode until more players join.\\##\\##"),
	CoreKill      = Translate("Congratulations! A Core Kill was added to your Scoreboard.\\##\\##"),
	TeamBounty    = Translate("{winnerteam} gets {reward} Booty for destroying {killedteam}\\##\\##");
}
...
{
	Translate("Blue\\Синие\\Azul"),
	Translate("Red\\Красные\\Vermelho"),
	Translate("Green\\Зелёные\\Verde"),
	Translate("Purple\\Фиолетовые\\Roxo"),
	Translate("Orange\\Оранжевые\\Laranja"),
	Translate("Cyan\\Бирюзовые\\Ciano"),
	Translate("Navy Blue\\Тёмно-синие\\Azul-marinho"),
	Translate("Beige\\Бежевые\\Bege")
};
	
const string[] shiprektTips =
{
	Translate("Pistols deal fair damage to Mothership Cores, but Machineguns are not effective at all!\\пистолеты наносят приличный урон Сердцу главного корабля, а Пулеметы совсем не эффективны!\\pistolas causam dano decente aos Núcleos de Navios-mãe, porém Metralhadoras não são nem um pouco eficazes!"),
	Translate("Target enemy ships that are higher on the leaderboard to get bigger rewards.\\атакуйте вражеские корабли, которые выше в таблице, чтобы получить большие награды.\\mire em navios inimigos que se encontram mais alto na tabela de classificação para conseguir recompensas melhores."),
	...
	Translate("Weapons don't stack! If you line them up only the outmost one will fire.\\оружие не стакается! Если вы выстроите их в линию, сработает только крайние из них.\\armas não empilham! Se você alinhá-las, apenas a mais distante irá disparar."),
	Translate("Flak cannons get a fire rate boost when they are manned.\\зенитные пушки получают повышение скорострельности, когда они пилотируются.\\canhões antiaéreos recebem um impulso de taxa de cadência quando são controlados manualmente."),
	...
	Translate("An engine's propeller blades destroy blocks, so be mindful of where you dock!\\лопасти пропеллера двигателя разрушают блоки, так что следите за тем, где вы швартуетесь!\\as pás da hélice de um motor destroem blocos, então fique atento de onde irá atracar!"),
	...
	Translate("Transfer Booty to your teammates by clicking the Coin icon at the lower HUD.\\передайте Добычу своим товарищам по команде, щелкнув значок монеты внизу.\\transfira Saque para seus colegas de equipe clicando no ícone de Moeda no HUD inferior."),
	...
	Translate("You can check how many enemy Motherships you have destroyed on the Tab board.\\Вы можете проверить, сколько вражеских главных кораблей вы уничтожили на вкладке Tab.\\você pode checar quantos Navios-mãe inimios você já destruiu na tabela do Tab."),
	Translate("Have the urge to point at something? Press and hold middle click.\\есть желание указать на что-то? Нажмите и удерживайте колёсико мыши.\\sente a necessidade de apontar para algo? Pressione e segure o botão do meio do mouse."),
	...
	Translate("Injured blocks cause less damage on collision.\\поврежденные блоки наносят меньше урона при столкновении.\\blocos danificados causam menos dano em colisões."),
	Translate("Strafe mode activates only the engines perpendicular to your ship.\\«режим стрейфа» активирует только двигатели, перпендикулярные вашему кораблю.\\o modo strafe ativa apenas os motores perpendiculares ao seu navio."),
	Translate("Players get a walk speed boost while aboard their Mothership.\\игроки получают повышение скорости ходьбы на борту своего главного корабля.\\jogadores ganham um impulso de velocidade de caminhada enquanto estiverem a bordo de seus Navios-mãe."),
	Translate("Players get healed over time while aboard their Mothership.\\игроки со временем исцеляются, находясь на борту своего главного корабля.\\jogadores são curados com o passar do tempo enquanto estiverem a bordo de seus Navios-mãe."),
	Translate("Adding more blocks to a ship will decrease its turning speed.\\добавление дополнительных блоков к кораблю уменьшает его скорость поворота.\\adicionar mais blocos para um navio irá reduzir sua velocidade de giro."),
	...
	Translate("Kill sharks or enemy players to get a small Booty reward.\\убивайте акул или вражеских игроков, чтобы получить небольшую Добычу.\\mate tubarões ou jogadores inimigos para ganhar uma pequena recompensa de Saque."),
	Translate("Crewmates get an Xs gathering boost while aboard their Mothership at the expense of their captain.\\товарищи по команде получают ускорение сбора X-ов на борту своего материнского корабля за счет своего капитана.\\tripulantes ganham um impulso de coleta de Xs enquanto estiverem a bordo de seus Navios-mãe às custas de seu capitão."),
	Translate("Xs give more Booty the closer they are to the center of the map.\\Х-ы дают больше добычи, чем ближе они к центру карты.\\Xs fornecem mais Saque conforme estão mais perto do centro do mapa."),
	Translate("Repulsors will activate propellers in near vicinity on detonation.\\репульсоры активируют пропеллеры в непосредственной близости от детонации.\\repulsores ativarão as hélices nas proximidades na detonação."),
	Translate("Keep an eye on your torpedoes, they can change direction if they bounce off the border!\\следите за своими торпедами, они могут изменить направление, если отскочат от границы карты!\\fique de olho em seus torpedos, eles podem mudar de direção se baterem no limite do mapa!"),
	Translate("Killing players while you're onboard their mothership gives you 3x the Booty reward!\\убивая игроков, пока вы находитесь на борту их материнского корабля, вы получаете в 3 раза больше добычи!\\matar jogadores enquanto você estiver no Navio-mãe deles fornecerá 3x a recompensa de Saque!"),
