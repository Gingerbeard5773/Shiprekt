...
// could be done better, onTick for this is inefficient!
void onTick(CRules@ this)
{
    ...
    if (timeToEnd <= 0)
    {
		//REMOVE THE COMMENTS BELOW TO ACTIVATE PLAYER AMOUNT DYNAMIC MAPS
...
string getRandomMap(CRules@ this)
{
	...
	if (pCount > 4 && pCount <= 10) //add these maps to the cycle if less than eleven players, but more than four players
		//maps.push_back( "TestMap.png" );

	if (pCount > 8) //add these maps to the cycle if more than eight players
