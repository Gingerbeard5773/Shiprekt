...
shared bool isTouchingLand(const Vec2f pos)
{
	CMap@ map = getMap();
...
shared bool isTouchingRock(const Vec2f pos)
{
	CMap@ map = getMap();
	const u16 tileType = map.getTile(pos).type;
...
shared bool isTouchingShoal(const Vec2f pos)
{
	CMap@ map = getMap();
	const u16 tileType = map.getTile(pos).type;
...
shared bool isInWater(const Vec2f pos)
{
	CMap@ map = getMap();
	const u16 tileType = map.getTile(pos).type;
